...
import { Brain, Search, FileText, Network, Clock, Mail, Users, X } from 'lucide-react';
...
export default function AnalysisProgress({ onComplete, onBackgroundMode, analysisConfig }: AnalysisProgressProps) {
  ...
  useEffect(() => {
    ...
    const runStep = (stepIndex: number) => {
      ...
      const animate = () => {
        ...
        const currentProgress = stepStart + (stepEnd - stepStart) * stepProgressPercent;
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {analysisConfig.mode === 'overall' ? '代码整体分析' : '代码逐个解析'}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{analysisConfig.selectedFiles.length} 个</span>
              </div>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div className="space-y-1">
                <div className="text-2xl font-bold text-green-600">{queueData.estimatedTime}分</div>
                <div className="text-xs text-gray-500">预估时间</div>
              </div>
              <div className="space-y-1">
                <div className="text-2xl font-bold text-purple-600">{queueData.totalInQueue}</div>
            ...
            <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-yellow-700">预计需要等待 {formatTime(queueData.estimatedTime)}，您可以留下邮箱后离开</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <Card className="p-4">
                  <form onSubmit={handleEmailSubmit} className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h4 className="font-medium text-gray-900">邮箱通知</h4>
                      <Button 
                        type="button"
                        variant="ghost" 
                        size="sm"
              ...
              <Card className="p-4 bg-green-50 border-green-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    <p className="font-medium text-green-800">邮箱通知已设置</p>
                    <p className="text-sm text-green-600">将发送到: {email}</p>
                  </div>
                </div>
              </Card>
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex items-center justify-center space-x-2">
                      <div className="w-8 h-8 bg-blue-200 rounded-full flex items-center justify-center">
                        <span className="text-lg font-bold text-blue-700">{countdown}</span>
                      </div>
                      <span className="text-sm text-blue-600">秒后自动跳转</span>
                    </div>
                  </div>
                </Card>
              )}
